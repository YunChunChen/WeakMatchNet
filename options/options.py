...
class ArgumentParser():
    ...
    def add_base_parameters(self):
        ...
        base_params.add_argument('--gpu', type=int, default=0, help='GPU setting')
    ...
    def add_train_parameters(self):
        ...
        train_params.add_argument('--w-inlier', type=float, default=0, help='weight for inlier loss')
        train_params.add_argument('--w-consis', type=float, default=0, help='weight for consistency loss')
        train_params.add_argument('--w-trans', type=float, default=0, help='weight for transitivity loss')
        train_params.add_argument('--seed', type=int, default=1, help='Pseudo-RNG seed')
        train_params.add_argument('--inlier-loss', type=str_to_bool, nargs='?', const=True, default=False, help='Use inlier loss?')        
        train_params.add_argument('--consistency-loss', type=str_to_bool, nargs='?', const=True, default=False, help='Use consistency loss?')        
        train_params.add_argument('--transitivity-loss', type=str_to_bool, nargs='?', const=True, default=False, help='Use transitivity loss?')        
        ...
        train_params.add_argument('--mask', type=str_to_bool, default=True, help='Use mask?')
        train_params.add_argument('--bi-directional', type=str_to_bool, default=True, help='Use bi-directional correlation?')
    ...
    def add_eval_parameters(self):
        ...
        eval_params.add_argument('--csv-path', type=str, default='', help='Path to csv file')
