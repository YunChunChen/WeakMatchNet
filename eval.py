...
from data.pf_dataset import PFDataset, PFPascalDataset, PFWillowDataset
...
elif args.eval_dataset=='pf_pascal' and not exists(args.eval_dataset_path):
...
elif args.eval_dataset=='pf_pascal':  
    Dataset = PFPascalDataset
    collate_fn = default_collate
    #csv_file = 'test_pairs_pf_pascal.csv'    
    csv_file = 'test_pf_pascal.csv'    
elif args.eval_dataset=='pf_willow':  
    Dataset = PFWillowDataset
    collate_fn = default_collate
    csv_file = 'test_pf_willow.csv'    
...
elif args.eval_dataset=='tss-pck':
    Dataset = TSSEvalDataset
    collate_fn = default_collate
    csv_file = 'test_tss_FG3DCar.csv'
    csv_file = 'test_tss_JODS.csv'
    csv_file = 'test_tss_PASCAL.csv'
